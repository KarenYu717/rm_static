    ...
    const info = {
        ...
        parameters: {
            ...
            window_resize_message: {
                ...
                default: `<p>您的浏览器窗口太小，无法完成此实验。请调整浏览器窗口大小。 
                如果您的浏览器窗口已经最大化，您将无法完成此实验。</p>
                <p>最小窗口宽度为 <span id="browser-check-min-width"></span> px.</p>
                <p>您当前的窗口宽度为 <span id="browser-check-actual-width"></span> px.</p>
                <p>最小窗口高度为 <span id="browser-check-min-height"></span> px.</p>
                <p>您当前的窗口高度为 <span id="browser-check-actual-height"></span> px.</p>
                <br /><br />
                <p style='font-style:italic'><span style='color: red'>提示：按【Ctrl】 + 【-】调节窗口大小。</span></p>`,
            },
            /**
